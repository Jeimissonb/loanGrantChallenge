            ...
            <div class="box-title">
              ...
              <div class="numbers">
                <div class="box-number orange">
                  <input type="text" class="number" id="valor-pretendido" data-mask="money" required>
                </div>
              ...
              <button type="button" class="btn btn-green">Calcular</button>
            </div>
              ...
              <div class="prazos">
                <div class="box-select">
                  ...
                  <label class="content" for="6-meses">
                    ...
                    <div class="number white limite-valor d-none">
                      ...
                      <span class="value"><div class="icon"><img src="/assets/images/hidden-white.svg" alt=""> <span>***</span></div> <span class="total">R$ 1000,00</span></span>
                    </div>

                    <div class="number limite-valor d-none">
                      <span class="desc">Valor da parcela:</span>
                      <span class="value"><div class="icon"><img src="/assets/images/hidden.svg" alt=""> <span>***</span></div> <span class="total">6x de: <br>R$ <span id="parcela6">2.685,00</span></span></span>
                    </div>
                ...
                <div class="box-select">
                  ...
                  <label class="content" for="12-meses">
                    ...
                    <div class="number limite-valor d-none">
                      <span class="desc">Valor da parcela:</span>
                      <span class="value"><div class="icon"><img src="/assets/images/hidden.svg" alt=""> <span>***</span></div> <span class="total">12x de: <br><span id="parcela12">1.410,00</span></span></span>
                    </div>
                ...
                <div class="box-select">
                  ...
                  <label class="content" for="24-meses">
                    ...
                    <div class="number limite-valor d-none">
                      <span class="desc">Valor da parcela:</span>
                      <span class="value"><div class="icon"><img src="/assets/images/hidden.svg" alt=""> <span>***</span></div> <span class="total">24x de: <br><span id="parcela24">780,00</span></span></span>
                    </div>
                ...
                <div class="box-select">
                  ...
                  <label class="content" for="36-meses">
                    ...
                    <div class="number limite-valor d-none">
                      <span class="desc">Valor da parcela:</span>
                      <span class="value"><div class="icon"><img src="/assets/images/hidden.svg" alt=""> <span>***</span></div> <span class="total">36x de: <br><span id="parcela36">555,00</span></span></span>
                    </div>
            ...
            <div class="prazo-estendido">
              ...
              <div class="box-interesse">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" class="custom-control-input" name="interesse" id="sim" value="sim">
                  <label class="custom-control-label" for="sim">Sim, estou interessado</label>
                </div>

                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" class="custom-control-input" name="interesse" id="nao" value="nao">
